...
b = [elem for elem in a if elem%2==0 and elem <=254]
print(b)
...
perimetr = 4*a
area = a*2
print("Периметр квадрата =", perimetr,";","Площадь квадрата =", area)
'''
'''
#4
#4.1
...
#4.2
car_mark = str(input("Введите марку автоиобиля: "))
date = int(input("Введите дату производства авто: "))
steering_wheel = str(input("Введите на какой стороне находится рулевое колесо: "))
usage = int(input("Введите сколько людей пользовалось машиной до этого: "))
cost = int(input("Введите цену авто: "))
